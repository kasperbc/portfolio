    ...
    return (
        <div>
            ...
            <ProjectPage
                gameName = "Epistasis"
                gameDescription=
                {"Epistasis is a 3D scifi-horror game developed with the Unity game engine, where you discover the remnants of a wrecked and abandoned space station and it is up to you to find out what happened, and (as one could expect,) you might not be the only one there. " +
                    ...
                    " The game includes many assets from the Asset Store and other external sources, to which the school gave a budget of 200€. <br /><br />" +
                    ...
                    " This phase, we had two weeks to plan the game and create a GDD and I would say things went much more smoothly this time." +
                    ...
                    " During this time, we also came with a lot of ideas that ended up being scrapped later, such as:" +
                    " <ul>" +
                    " <li>a</li>" +
                    " <li>b</li>" +
                    " </ul>" +
                ...
                tech="Unity, 3D, C#, HDRP, Scrum, Git, Jira, Miro, ChatGPT, AI, Blender, Photoshop"
            />
        </div>
    )
}